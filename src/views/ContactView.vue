      ...
      <div v-reveal class="p-8 card-surface">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <a href="https://github.com/ejayarma" target="_blank" rel="noopener noreferrer"
            ...
            <div class="flex items-center justify-center w-10 h-10 mr-4 transition-transform duration-300 rounded-full shrink-0 bg-brand">
              <svg class="w-5 h-5 text-darkest" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
